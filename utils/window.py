...
class OskWindow(Window):
    def __init__(self, window_name):
        ...
        self.key_pos = {'space': (70, 161), 'Fn': (7, 160), '1': (29, 69), '2': (40, 72),
                        '3': (50, 71), '4': (60, 70), 'z': (34, 138), 'e': (43, 92),
                        'q': (22, 92), 'g': (67, 115), 't': (62, 90), 'Ctrl': (17, 161),
                        'h': (78, 112), 'r': (52, 92), 'f': (56, 112), 'b': (76, 136)
                        }
